...
if __name__ == "__main__":
    ...
    # BFE
    r_BFE, rho_BFE = BFE_density_profile(pos_cm, S[0], T[0], 1, r_s, rmax=100, nbins=50)
    r_BFE, pot_BFE = BFE_potential_profile(pos_cm, S[0], T[0], 1, r_s, G, rmax=100, nbins=50)
    ...
    plt.loglog(r_BFE, rho_BFE, c='k')
    plt.loglog(r_NB, rho_NB, c='C9', ls='--')
    plt.loglog(r_NB, rho_teo, c='C1', ls=':')
